...
public inline fun Skill.Builder.completeBehavior(crossinline block: SkillContext.() -> Unit): Skill.Builder =
    setCompleteBehavior(SkillCompleteBehavior(block))

public inline fun Skill.Builder.endBehavior(crossinline block: SkillContext.() -> Unit): Skill.Builder =
    setEndBehavior(SkillEndBehavior(block))

public inline fun Skill.Builder.startBehavior(crossinline block: SkillContext.() -> Unit): Skill.Builder =
    setStartBehavior(SkillStartBehavior(block))

public inline fun Skill.Builder.tickBehavior(crossinline block: SkillContext.() -> Unit): Skill.Builder =
...
public inline fun Skill.Builder.cancelHandler(crossinline block: SkillContext.() -> Boolean): Skill.Builder =
    setCancelHandler(SkillCancelHandler(block))

public inline fun Skill.Builder.interruptHandler(crossinline block: SkillContext.() -> Boolean): Skill.Builder =
